  ...
  return (
    <footer className="platform-footer">
      ...
      <div className="footer-link-groups">
        ...
        <section><b>资源与实践</b><a href="/tools/compound/">金融小工具</a><a href="/books/">财经图书</a><a href="/videos/">视频课程</a><a href="/editorial-policy/">内容标准</a><a href="/site-statistics/">访问统计</a></section>
      </div>
      <div className="footer-bottom"><span>© 2026 财知道</span><span>本站内容用于学习，不构成投资、税务或法律建议。</span></div>
    </footer>
  );
}

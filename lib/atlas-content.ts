...
const disciplineDepth: Record<string, DisciplineDepth> = {
  microeconomics: {
    ...
    references: [{ title: 'Principles of Economics', publisher: 'OpenStax', url: 'https://openstax.org/details/books/principles-economics-3e', note: '开放教材，系统覆盖选择、供需、企业与市场失灵。' }, { title: 'The Economy', publisher: 'CORE Econ', url: 'https://www.core-econ.org/the-economy/', note: '以现实问题和数据组织的开放经济学教材。' }],
  },
  macroeconomics: {
  ...
  'financial-markets': {
    ...
    references: [{ title: 'How Stock Markets Work', publisher: 'Investor.gov · U.S. SEC', url: 'https://www.investor.gov/introduction-investing/investing-basics/how-stock-markets-work', note: '发行、交易、订单与市场参与者的基础资料。' }, { title: 'Investing', publisher: 'FINRA', url: 'https://www.finra.org/investors/investing', note: '证券产品、市场机制、交易成本和投资风险资料。' }],
  },
  investment: {
    ...
    references: [{ title: 'What Is Risk?', publisher: 'Investor.gov · U.S. SEC', url: 'https://www.investor.gov/introduction-investing/investing-basics/what-risk', note: '风险、收益、分散投资、费用与金融产品资料。' }, { title: 'Investment Foundations', publisher: 'CFA Institute', url: 'https://www.cfainstitute.org/programs/investment-foundations', note: '投资工具、组合、客户目标与行业实践的系统框架。' }],
  },
  'corporate-finance': {
    ...
    references: [{ title: 'Valuation resources', publisher: 'NYU Stern · Aswath Damodaran', url: 'https://pages.stern.nyu.edu/~adamodar/', note: '公司金融、估值课程、数据与案例。' }, { title: 'Principles of Finance', publisher: 'OpenStax', url: 'https://openstax.org/details/books/principles-finance', note: '货币时间价值、资本预算、融资、风险和估值开放教材。' }],
  },
  accounting: {
    ...
    references: [{ title: 'Issued IFRS Standards', publisher: 'IFRS Foundation', url: 'https://www.ifrs.org/issued-standards/list-of-standards/', note: '国际财务报告准则与配套资料。' }, { title: 'Beginners’ Guide to Financial Statements', publisher: 'U.S. Securities and Exchange Commission', url: 'https://www.sec.gov/about/reports-publications/investorpubsbegfinstmtguide', note: '三张财务报表及其相互关系的投资者说明。' }],
  },
  'personal-finance': {
    ...
    references: [{ title: 'Consumer Tools', publisher: 'U.S. Consumer Financial Protection Bureau', url: 'https://www.consumerfinance.gov/consumer-tools/', note: '信用、贷款、住房与家庭财务工具。' }, { title: 'Saving and Investing', publisher: 'Investor.gov · U.S. SEC', url: 'https://www.investor.gov/introduction-investing/investing-basics/save-and-invest', note: '储蓄目标、投资计划和长期资金安排的基础资料。' }],
  },
  'public-finance': {
    ...
    references: [{ title: 'Fiscal Monitor', publisher: 'International Monetary Fund', url: 'https://www.imf.org/en/Publications/FM', note: '财政政策、债务和公共收支的国际资料。' }, { title: 'Tax', publisher: 'OECD', url: 'https://www.oecd.org/tax/', note: '税收制度、收入统计、归宿与政策比较资料。' }],
  },
  'international-economics': {
    ...
    references: [{ title: 'Balance of Payments Manual', publisher: 'International Monetary Fund', url: 'https://www.imf.org/external/pubs/ft/bop/2007/bopman6.htm', note: '国际收支与跨境头寸的定义和统计框架。' }, { title: 'Trade Statistics', publisher: 'World Trade Organization', url: 'https://www.wto.org/english/res_e/statis_e/statis_e.htm', note: '国际贸易、关税、商品与服务流量的原始统计入口。' }],
  },
  'behavioral-economics': {
    ...
    references: [{ title: 'Daniel Kahneman · Facts', publisher: 'The Nobel Prize', url: 'https://www.nobelprize.org/prizes/economic-sciences/2002/kahneman/facts/', note: '判断与不确定性研究的背景资料。' }, { title: 'World Development Report 2015: Mind, Society, and Behavior', publisher: 'World Bank', url: 'https://www.worldbank.org/en/publication/wdr2015', note: '行为研究如何进入发展和公共政策的机构报告。' }],
  },
  'fintech-risk': {
    ...
    references: [{ title: 'FinTech', publisher: 'Financial Stability Board', url: 'https://www.fsb.org/work-of-the-fsb/financial-innovation-and-structural-change/fintech/', note: '金融创新、市场结构与金融稳定资料。' }, { title: 'Innovation and Fintech', publisher: 'Bank for International Settlements', url: 'https://www.bis.org/topic/fintech.htm', note: '支付、数字货币、平台、监管和金融稳定研究。' }],
  },
};

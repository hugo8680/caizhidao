  ...
  return (
    <main className="knowledge-essay-page">
      <header className="knowledge-essay-header">
        <p className="knowledge-essay-breadcrumb"><a href="/">财知道</a><span>／</span>关于本站</p>
        <p className="knowledge-essay-kicker">Editorial Standards · 最近修订 {editorialReviewDate}</p>
        <h1>内容标准与资料原则</h1>
        <p className="knowledge-essay-question">财经科普的目标不是把术语说得简单，而是在不牺牲准确性的前提下，把关系讲清楚。</p>
        <p className="knowledge-essay-deck">本站面向非专业读者，内容用于建立经济学、金融学和会计学的基础理解。它不提供个别证券推荐，也不替代持牌专业人士针对个人情况给出的建议。</p>
      </header>
      ...
      <article className="knowledge-essay">
        ...
        <section>
          ...
          <p><a href="https://github.com/hugo8680/caizhidao/issues" target="_blank" rel="noreferrer">在 GitHub 提交内容问题 ↗</a></p>
        </section>
